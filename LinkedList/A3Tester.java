...
public class A3Tester {
	...
	public static void testRotate() {
		...
		displayResults(result2.equals("{OPQRLMN}"), "testRotate");
		/* Write additional tests here to ensure all of your pointers
		   have been updated correctly. */
	...
	public static void testInterleave() {
		...
		displayResults(result1.equals("{ABCDEF}"), "testInterleave");
		...
		//list2.addBack("R");
		result2 = list2.frontToBack();
		displayResults(result2.equals("{LMNOPQ}"), "testInterleave");
		
		list1.interleave(list2);
		result1 = list1.frontToBack();
		result2 = list2.frontToBack();
		
		displayResults(result1.equals("{AMCOEQ}"), "testInterleave");
